...
import tiny.connector.ResponseStream;
import tiny.connector.ResponseWriter;
import tiny.connector.util.CookieTools;
...
public class HttpResponse implements HttpServletResponse {
     ...
     */
    protected final ArrayList cookies = new ArrayList();
    /**
    ...
    protected void sendHeader() {
        ...
        PrintWriter outputWriter = new ResponseWriter(osr);
        ...
        if (getContentLength() >= 0) {
            outputWriter.print("Content-Length: " + getContentType() + "\r\n");
        }
    ...
    public void addDataHeader(String name, String value) {
        if (isCommitted())
            return;
        addHeader(name, format.format(new Date()));
    }
